## [3144. 排兵布阵](https://www.acwing.com/problem/content/3147/)

### 题目

小 *C* 正在玩一款排兵布阵的游戏。

在游戏中有 *n* 座城堡，每局对战由两名玩家来争夺这些城堡。

每名玩家有 *m* 名士兵，可以向第 *i* 座城堡派遣 *a_i* 名士兵去争夺这个城堡，使得总士兵数不超过 *m*。
...
- *1le n ≤ 100*
- *1le m ≤ 20000*
- 对于每名玩家 *a_i ≥ 0*，*sumlimits_{i=1}^n a_i ≤ m*
