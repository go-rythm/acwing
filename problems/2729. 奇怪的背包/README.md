## [2729. 奇怪的背包](https://www.acwing.com/problem/content/2731/)
...
他会进行 *q* 次询问，每次询问给出重量 *w_i*，你需要回答有多少种放入物品的方案，能将一个初始为空的背包的重量变为 *w_i*。

注意，两种方案被认为是不同的，当且仅当放入物品的种类不同，而与每种物品放入的个数无关，不难发现总的方案数为 *2^n*。
